...
app = Flask(__name__)
CORS(app, origins=["https://buil-server.onrender.com", "http://http://localhost:5173"], supports_credentials=True)
            ...
            messages=[
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "תוציא לי את כל המידע שאתה מבין מתוכנית הבנייה בתמונה (בעיברית בלבד)"
                        },
                        {
                            "type": "image_url",
                            "image_url": {
